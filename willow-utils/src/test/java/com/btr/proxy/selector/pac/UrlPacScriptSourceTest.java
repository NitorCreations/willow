...
public class UrlPacScriptSourceTest {
  ...
  public void testHttpCharsetParser() {
    ...
    String charset = scriptSource
        .parseCharsetFromHeader("application/x-ns-proxy-autoconfig; charset=UTF-8");
  ...
  public void testHttpCharsetParserDefault() {
    UrlPacScriptSource scriptSource = new UrlPacScriptSource("");
    String charset = scriptSource
        .parseCharsetFromHeader("application/octet-stream;");
  ...
  public void overrideTimeoutShouldWork() {
    ...
    UrlPacScriptSource scriptSource = new UrlPacScriptSource("");
    int timeout = scriptSource.getTimeOut(
        UrlPacScriptSource.OVERRIDE_CONNECT_TIMEOUT, 1000);
